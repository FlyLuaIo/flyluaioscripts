...
uluaLog('WinWing AGP for Inibuild A380')
...
wwagp:CfgRpn(5, '0 (>L:INI_ANTISKID_SWITCH)')
wwagp:CfgRpn(6, '1 (>L:INI_ANTISKID_SWITCH)')
...
wwagp:CfgRpn(16, '0 (>L:INI_CLOCK_GPS_STATE)')
wwagp:CfgRpn(17, '1 (>L:INI_CLOCK_GPS_STATE)')
wwagp:CfgRpn(18, '2 (>L:INI_CLOCK_GPS_STATE)')
...
--====backlight
wwagp:GetBkl("(L:INI_CKPT_LT_INTEG)", 2.4)          -- 0~100
wwagp:GetDigiBkl("(L:INI_battery_on, number)", 200) -- 0~1
wwagp:GetLedBkl("(L:INI_battery_on, number)", 200)  -- 0~1
--================================ Input LED/LCD ===
wwagp:GetUlockL("(L:INI_GEAR1_UNLK_LIGHT)")
...
wwagp:GetLockL("(L:INI_GEAR1_POSITION) 50 ==")
wwagp:GetLockN("(L:INI_GEAR0_POSITION) 50 == (L:INI_GEAR3_POSITION) 50 == and")
...
wwagp:GetMaxD('(L:INI_AUTOBRAKE_LEVEL) 4 == (L:INI_AUTOBRAKE_ARMED) and')
wwagp:GetLow('(L:INI_LG_ABRK_LEVEL) 2 ==')
wwagp:GetMed('(L:INI_LG_ABRK_LEVEL) 3 ==')
wwagp:GetMax(

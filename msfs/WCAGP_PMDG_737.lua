...
uluaLog('WinCtrl AGP for PMDG737')
...
---- SYS
wcagp:CfgRpn(5, '50300 1 + (>K:ROTOR_BRAKE) (L:switch_504_73X, number) 0 != if{ 50401 (>K:ROTOR_BRAKE) }',
...
wcagp:CfgRpn(11, "31401 (>K:ROTOR_BRAKE)")

--ET
wcagp:CfgRpn(19, "32101 (>K:ROTOR_BRAKE)", "32101 (>K:ROTOR_BRAKE)")
wcagp:CfgRpn(21, "32001 (>K:ROTOR_BRAKE)")

-- TERR
wcagp:CfgRpn(22, "37501 (>K:ROTOR_BRAKE)")
wcagp:CfgRpn(23, '(>K:GEAR_UP)', '(>K:GEAR_DOWN)')


--====backlight
wcagp:GetBkl('(L:BL_MainCA, number) 100 * near', 2)
wcagp:GetDigiBkl("(A:LIGHT POTENTIOMETER:85, Percent)", 2) -- 0~100
wcagp:GetLedBkl("(A:LIGHT POTENTIOMETER:85, Percent)", 2)  -- 0~100
--================================ Input LED/LCD ===
wcagp:GetUlockL("(L:switch_451_73X, number)")
wcagp:GetUlockN("(L:switch_449_73X, number)")
wcagp:GetUlockR("(L:switch_452_73X, number)")
wcagp:GetBrakeHot('cpuwolf/flyluaio/WwAgp/condbtn[1]')
wcagp:GetLockL("(L:switch_453_73X, number)")
wcagp:GetLockN("(L:switch_450_73X, number)")
wcagp:GetLockR("(L:switch_454_73X, number)")
wcagp:GetBrakeOn('(L:switch_505_73X) 0 ==')
...
wcagp:GetLow('(L:switch_460_73X) 20 ==')
wcagp:GetMed('(L:switch_460_73X) 30 ==')
wcagp:GetMax('(L:switch_460_73X) 50 == (L:switch_460_73X) 0 == or')

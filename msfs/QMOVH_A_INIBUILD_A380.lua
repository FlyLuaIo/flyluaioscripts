...
---- XBLEED
qmovha:CfgRpn(27, "0 (>B:AIRLINER_AIR_XBLEED_0)")
qmovha:CfgRpn(28, "1 (>B:AIRLINER_AIR_XBLEED_1)")
qmovha:CfgRpn(29, "2 (>B:AIRLINER_AIR_XBLEED_2)")
...
---- BAT1
qmovha:CfgRpn(59,
    "(L:INI_BATTERY_1_SWITCH) ! (>L:INI_BATTERY_1_SWITCH) (L:INI_BATTERY_1_SWITCH) (>L:INI_BATTERY_ESS_SWITCH)")
---- BAT2
qmovha:CfgRpn(60,
...
---- L1
qmovha:CfgRpn(54,
    "(L:INI_FUEL_PUMP_OUTR_LEFT) ! (>L:INI_FUEL_PUMP_OUTR_LEFT)")
---- L2
qmovha:CfgRpn(68,
    "(L:INI_FUEL_PUMP_FWD_MID_LEFT) ! (>L:INI_FUEL_PUMP_FWD_MID_LEFT) (L:INI_FUEL_PUMP_FWD_MID_LEFT) (>L:INI_FUEL_PUMP_AFT_MID_LEFT) (L:INI_FUEL_PUMP_FWD_MID_LEFT) (>L:INI_FUEL_PUMP_MAIN_FEED_1) (L:INI_FUEL_PUMP_FWD_MID_LEFT) (>L:INI_FUEL_PUMP_STBY_FEED_1)")
---- C1
qmovha:CfgRpn(67,
    "(L:INI_FUEL_PUMP_FWD_INR_LEFT) ! (>L:INI_FUEL_PUMP_FWD_INR_LEFT) (L:INI_FUEL_PUMP_FWD_INR_LEFT) (>L:INI_FUEL_PUMP_AFT_INR_LEFT) (L:INI_FUEL_PUMP_FWD_INR_LEFT) (>L:INI_FUEL_PUMP_MAIN_FEED_2) (L:INI_FUEL_PUMP_FWD_INR_LEFT) (>L:INI_FUEL_PUMP_STBY_FEED_2) (L:INI_FUEL_PUMP_FWD_INR_LEFT) (>L:INI_FUEL_PUMP_TRIM_LEFT)")
---- C2
qmovha:CfgRpn(65,
    "(L:INI_FUEL_PUMP_FWD_INR_RIGHT) ! (>L:INI_FUEL_PUMP_FWD_INR_RIGHT) (L:INI_FUEL_PUMP_FWD_INR_RIGHT) (>L:INI_FUEL_PUMP_AFT_INR_RIGHT) (L:INI_FUEL_PUMP_FWD_INR_RIGHT) (>L:INI_FUEL_PUMP_MAIN_FEED_3) (L:INI_FUEL_PUMP_FWD_INR_RIGHT) (>L:INI_FUEL_PUMP_STBY_FEED_3) (L:INI_FUEL_PUMP_FWD_INR_RIGHT) (>L:INI_FUEL_PUMP_TRIM_RIGHT)")
---- R1
qmovha:CfgRpn(64,
    "(L:INI_FUEL_PUMP_FWD_MID_RIGHT) ! (>L:INI_FUEL_PUMP_FWD_MID_RIGHT) (L:INI_FUEL_PUMP_FWD_MID_RIGHT) (>L:INI_FUEL_PUMP_AFT_MID_RIGHT) (L:INI_FUEL_PUMP_FWD_MID_RIGHT) (>L:INI_FUEL_PUMP_MAIN_FEED_4) (L:INI_FUEL_PUMP_FWD_MID_RIGHT) (>L:INI_FUEL_PUMP_STBY_FEED_4)")
---- R2
qmovha:CfgRpn(63,
    "(L:INI_FUEL_PUMP_OUTR_RIGHT) ! (>L:INI_FUEL_PUMP_OUTR_RIGHT)")
---- XFEED
qmovha:CfgRpn(66,
    "(L:INI_XFEED_TRANSFER_ON) ! (>L:INI_XFEED_TRANSFER_ON) (L:INI_XFEED_TRANSFER_ON) (>L:INI_XFEED_TRANSFER2_ON) (L:INI_XFEED_TRANSFER_ON) (>L:INI_XFEED_TRANSFER3_ON) (L:INI_XFEED_TRANSFER_ON) (>L:INI_XFEED_TRANSFER4_ON)")
...
---- ENG1
qmovha:CfgRpn(82, "1 (>B:AIRLINER_FIRE_PB_ENG_1_Cover_Set) 1 (>L:INI_FIRE_ENG_1_FIRE_PB)",
    "0 (>L:INI_FIRE_ENG_1_FIRE_PB)")
---- APU
...
---- ENG2
qmovha:CfgRpn(84, "1 (>B:AIRLINER_FIRE_PB_ENG_2_Cover_Set) 1 (>L:INI_FIRE_ENG_2_FIRE_PB)",
    "0 (>L:INI_FIRE_ENG_2_FIRE_PB)")
...
qmovha:GetUpled1Ltk1Up('(L:INI_FUEL_PUMP_OUTR_LEFT_FAULT)')
qmovha:GetUpled1Ltk1Dn('(L:INI_FUEL_PUMP_OUTR_LEFT) !')
qmovha:GetUpled1Ltk2Up('(L:INI_FUEL_PUMP_STBY_FEED_1_FAULT)')
qmovha:GetUpled1Ltk2Dn(
    '(L:INI_FUEL_PUMP_FWD_MID_LEFT) ! (L:INI_FUEL_PUMP_AFT_MID_LEFT) ! or (L:INI_FUEL_PUMP_MAIN_FEED_1) ! or (L:INI_FUEL_PUMP_STBY_FEED_1) ! or')
qmovha:GetUpled1CtklUp('(L:INI_FUEL_PUMP_STBY_FEED_2_FAULT)')
qmovha:GetUpled1CtklDn(
    '(L:INI_FUEL_PUMP_FWD_INR_LEFT) ! (L:INI_FUEL_PUMP_AFT_INR_LEFT) ! or (L:INI_FUEL_PUMP_MAIN_FEED_2) ! or (L:INI_FUEL_PUMP_STBY_FEED_2) ! or (L:INI_FUEL_PUMP_TRIM_LEFT) ! or')
qmovha:GetUpled1CtkrUp('(L:INI_FUEL_PUMP_STBY_FEED_3_FAULT)')
qmovha:GetUpled1CtkrDn(
    '(L:INI_FUEL_PUMP_FWD_INR_RIGHT) ! (L:INI_FUEL_PUMP_AFT_INR_RIGHT) ! or (L:INI_FUEL_PUMP_MAIN_FEED_3) ! or (L:INI_FUEL_PUMP_STBY_FEED_3) ! or (L:INI_FUEL_PUMP_TRIM_RIGHT) ! or')
qmovha:GetUpled2Rtk1Up('(L:INI_FUEL_PUMP_STBY_FEED_4_FAULT)')
qmovha:GetUpled2Rtk1Dn(
    '(L:INI_FUEL_PUMP_FWD_MID_RIGHT) ! (L:INI_FUEL_PUMP_AFT_MID_RIGHT) ! or (L:INI_FUEL_PUMP_MAIN_FEED_4) ! or (L:INI_FUEL_PUMP_STBY_FEED_4) ! or')
qmovha:GetUpled2Rtk2Up('(L:INI_FUEL_PUMP_OUTR_RIGHT_FAULT)')
qmovha:GetUpled2Rtk2Dn('(L:INI_FUEL_PUMP_OUTR_RIGHT) !')

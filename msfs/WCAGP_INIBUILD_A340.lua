...
uluaLog('WinCtrl AGP for Inibuild A340')
...
wcagp:CfgRpn(5, '1 (>L:INI_ANTISKID_SWITCH)')
wcagp:CfgRpn(6, '0 (>L:INI_ANTISKID_SWITCH)')
...
--====backlight
wcagp:GetBkl("(L:INI_POTENTIOMETER_14, Percent)", 1)                 -- 0~100
wcagp:GetDigiBkl("(L:INI_DC_ESSENTIAL_BUS_IS_POWERED, number)", 120) -- 0~1
wcagp:GetLedBkl("(L:INI_DC_ESSENTIAL_BUS_IS_POWERED, number)", 120)  -- 0~1
--================================ Input LED/LCD ===
...
wcagp:GetMaxD('(L:INI_AUTOBRAKE_HI_DECEL)')
wcagp:GetLow('(L:INI_AUTOBRAKE_LEVEL) 5 ==')
wcagp:GetMed('(L:INI_AUTOBRAKE_LEVEL) 3 ==')
wcagp:GetMax('(L:INI_AUTOBRAKE_LEVEL) 4 ==')

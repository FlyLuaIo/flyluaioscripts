...
tcaqeng12:CfgRpn(24, '(L:switch_498_a) 0 == if{ 498201 (>K:ROTOR_BRAKE)' , '(L:switch_498_a) 200 == if{ 498201 (>K:ROTOR_BRAKE)')

---- ENG STSRT
-- ENG L IDEL/CUTOFF
tcaqeng12:CfgRpn(2, '(L:switch_520_a) 100 == if{ 52001 (>K:ROTOR_BRAKE) }' , '(L:switch_520_a) 0 == if{ 52001 (>K:ROTOR_BRAKE) }')
-- ENG R IDEL/CUTOFF
tcaqeng12:CfgRpn(3, '(L:switch_521_a) 100 == if{ 52101 (>K:ROTOR_BRAKE) }' , '(L:switch_521_a) 0 == if{ 52101 (>K:ROTOR_BRAKE) }')
---- AUTOBREAK

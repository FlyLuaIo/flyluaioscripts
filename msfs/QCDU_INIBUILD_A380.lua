...
uluaLog("QCDU-A320 for Inibuild A380")
...
qcdua:CfgRpn(24, '1 (>L:INI_MCDU1_UP)')
qcdua:CfgRpn(25, '1 (>L:INI_MCDU1_LEFT)')
qcdua:CfgRpn(26, '1 (>L:INI_MCDU1_RIGHT)')
...
qcdua:CfgRpn(68, '1 (>L:INI_MCDU1_BACKSPACE)')
...
qcdua:GetBkl("(L:INI_CKPT_LT_INTEG, Percent)", 1)

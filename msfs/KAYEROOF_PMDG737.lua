...
kayeroof:CfgRpn(54,
	'(L:OH_PANEL_LIGHT_CONTROL, number) 3 + 300 min (>L:OH_PANEL_LIGHT_CONTROL, number) (L:CA_MAIN_PANEL_LIGHT_CONTROL, number) 3 + 300 min (>L:CA_MAIN_PANEL_LIGHT_CONTROL, number) (L:PED_PANEL_LIGHT_CONTROL, number) 3 + 300 min (>L:PED_PANEL_LIGHT_CONTROL, number)')
kayeroof:CfgRpn(57,
	'(L:OH_PANEL_LIGHT_CONTROL, number) 3 - 0 max (>L:OH_PANEL_LIGHT_CONTROL, number) (L:CA_MAIN_PANEL_LIGHT_CONTROL, number) 3 - 0 max (>L:CA_MAIN_PANEL_LIGHT_CONTROL, number) (L:PED_PANEL_LIGHT_CONTROL, number) 3 - 0 max (>L:PED_PANEL_LIGHT_CONTROL, number)')
kayeroof:CfgRpn(55,
	'(L:OH_PANEL_LIGHT_CONTROL, number) 3 + 300 min (>L:OH_PANEL_LIGHT_CONTROL, number) (L:CA_MAIN_PANEL_LIGHT_CONTROL, number) 3 + 300 min (>L:CA_MAIN_PANEL_LIGHT_CONTROL, number) (L:PED_PANEL_LIGHT_CONTROL, number) 3 + 300 min (>L:PED_PANEL_LIGHT_CONTROL, number)')
kayeroof:CfgRpn(56,
	'(L:OH_PANEL_LIGHT_CONTROL, number) 3 - 0 max (>L:OH_PANEL_LIGHT_CONTROL, number) (L:CA_MAIN_PANEL_LIGHT_CONTROL, number) 3 - 0 max (>L:CA_MAIN_PANEL_LIGHT_CONTROL, number) (L:PED_PANEL_LIGHT_CONTROL, number) 3 - 0 max (>L:PED_PANEL_LIGHT_CONTROL, number)')
...
kayeroof:CfgRpn(0,
	'0 (L:switch_119_73X) - 10 div s0 :1 l0 0 > if{ 11907 (>K:ROTOR_BRAKE) l0 -- s0 g1 } l0 0 < if{ 11908 (>K:ROTOR_BRAKE) l0 ++ s0 g1 }')
-- bit 1 GNADIRS_1_NAV ← PMDG737 ENG START L OFF
kayeroof:CfgRpn(1,
	'10 (L:switch_119_73X) - 10 div s0 :1 l0 0 > if{ 11907 (>K:ROTOR_BRAKE) l0 -- s0 g1 } l0 0 < if{ 11908 (>K:ROTOR_BRAKE) l0 ++ s0 g1 }')
-- bit 2 GNADIRS_1_ATT ← PMDG737 ENG START L CONT
kayeroof:CfgRpn(2,
	'20 (L:switch_119_73X) - 10 div s0 :1 l0 0 > if{ 11907 (>K:ROTOR_BRAKE) l0 -- s0 g1 } l0 0 < if{ 11908 (>K:ROTOR_BRAKE) l0 ++ s0 g1 }')
-- bit 3 GNADIRS_3_OFF ← PMDG737 ENG START R GND
kayeroof:CfgRpn(3,
	'0 (L:switch_121_73X) - 10 div s0 :1 l0 0 > if{ 12107 (>K:ROTOR_BRAKE) l0 -- s0 g1 } l0 0 < if{ 12108 (>K:ROTOR_BRAKE) l0 ++ s0 g1 }')
-- bit 4 GNADIRS_3_NAV ← PMDG737 ENG START R OFF
kayeroof:CfgRpn(4,
	'10 (L:switch_121_73X) - 10 div s0 :1 l0 0 > if{ 12107 (>K:ROTOR_BRAKE) l0 -- s0 g1 } l0 0 < if{ 12108 (>K:ROTOR_BRAKE) l0 ++ s0 g1 }')
-- bit 5 GNADIRS_3_ATT ← PMDG737 ENG START R CONT
kayeroof:CfgRpn(5,
	'20 (L:switch_121_73X) - 10 div s0 :1 l0 0 > if{ 12107 (>K:ROTOR_BRAKE) l0 -- s0 g1 } l0 0 < if{ 12108 (>K:ROTOR_BRAKE) l0 ++ s0 g1 }')
-- bit 6 GNADIRS_2_OFF ← PMDG737 IRS L/R OFF
kayeroof:CfgRpn(6,
	'0 (L:switch_255_73X) - 10 div s0 :1 l0 0 > if{ 25507 (>K:ROTOR_BRAKE) l0 -- s0 g1 } l0 0 < if{ 25508 (>K:ROTOR_BRAKE) l0 ++ s0 g1 } 0 (L:switch_256_73X) - 10 div s0 :1 l0 0 > if{ 25607 (>K:ROTOR_BRAKE) l0 -- s0 g1 } l0 0 < if{ 25608 (>K:ROTOR_BRAKE) l0 ++ s0 g1 }')
-- bit 7 GNADIRS_2_NAV ← PMDG737 IRS L/R NAV
kayeroof:CfgRpn(7,
	'20 (L:switch_255_73X) - 10 div s0 :1 l0 0 > if{ 25507 (>K:ROTOR_BRAKE) l0 -- s0 g1 } l0 0 < if{ 25508 (>K:ROTOR_BRAKE) l0 ++ s0 g1 } 20 (L:switch_256_73X) - 10 div s0 :1 l0 0 > if{ 25607 (>K:ROTOR_BRAKE) l0 -- s0 g1 } l0 0 < if{ 25608 (>K:ROTOR_BRAKE) l0 ++ s0 g1 }')
-- bit 8 GNADIRS_2_ATT ← PMDG737 IRS L/R ATT
kayeroof:CfgRpn(8,
	'30 (L:switch_255_73X) - 10 div s0 :1 l0 0 > if{ 25507 (>K:ROTOR_BRAKE) l0 -- s0 g1 } l0 0 < if{ 25508 (>K:ROTOR_BRAKE) l0 ++ s0 g1 } 30 (L:switch_256_73X) - 10 div s0 :1 l0 0 > if{ 25607 (>K:ROTOR_BRAKE) l0 -- s0 g1 } l0 0 < if{ 25608 (>K:ROTOR_BRAKE) l0 ++ s0 g1 }')
...
kayeroof:CfgRpn(27,
	'100 (L:switch_118_73X,number) - 50 div s0 :1 l0 0 > if{ 11801 (>K:ROTOR_BRAKE) l0 -- s0 g1 } l0 0 < if{ 11802 (>K:ROTOR_BRAKE) l0 ++ s0 g1 }',
	'50 (L:switch_118_73X,number) - 50 div s0 :1 l0 0 > if{ 11801 (>K:ROTOR_BRAKE) l0 -- s0 g1 } l0 0 < if{ 11802 (>K:ROTOR_BRAKE) l0 ++ s0 g1 }')
...
kayeroof:CfgRpn(32,
	'(L:switch_202_73X, number) s0 l0 50 == if{ 20202 (>K:ROTOR_BRAKE) } l0 100 == if{ 20202 (>K:ROTOR_BRAKE) 20202 (>K:ROTOR_BRAKE) }',
	'(L:switch_202_73X, number) s0 l0 0 == if{ 20201 (>K:ROTOR_BRAKE) } l0 100 == if{ 20202 (>K:ROTOR_BRAKE) }')
-- bit 33 EMER EXIT LT_OFF ← PMDG737 ISOLATION VALVE OPEN/AUTO
kayeroof:CfgRpn(33,
	'(L:switch_202_73X, number) s0 l0 50 == if{ 20201 (>K:ROTOR_BRAKE) } l0 0 == if{ 20201 (>K:ROTOR_BRAKE) 20201 (>K:ROTOR_BRAKE) }',
	'(L:switch_202_73X, number) s0 l0 0 == if{ 20201 (>K:ROTOR_BRAKE) } l0 100 == if{ 20202 (>K:ROTOR_BRAKE) }')
-- bit 34 SEAT BELTS_OFF ← PMDG737 NOSMOKING ON/OFF
kayeroof:CfgRpn(34, '100 (L:switch_103_73X, number) == if{ 10302 (>K:ROTOR_BRAKE) }',
	'0 (L:switch_103_73X, number) == if{ 10301 (>K:ROTOR_BRAKE) }')
-- bit 35 NO SMOKING_OFF ← PMDG737 SEATBELTS AUTO/OFF
kayeroof:CfgRpn(35,
	'(L:switch_104_73X, number) s0 l0 50 == if{ 10402 (>K:ROTOR_BRAKE) } l0 100 == if{ 10402 (>K:ROTOR_BRAKE) 10402 (>K:ROTOR_BRAKE) }',
	'(L:switch_104_73X, number) s0 l0 0 == if{ 10401 (>K:ROTOR_BRAKE) } l0 100 == if{ 10402 (>K:ROTOR_BRAKE) }')
-- bit 36 NO SMOKING_ON ← PMDG737 SEATBELTS ON/AUTO
kayeroof:CfgRpn(36,
	'(L:switch_104_73X, number) s0 l0 50 == if{ 10401 (>K:ROTOR_BRAKE) } l0 0 == if{ 10401 (>K:ROTOR_BRAKE) 10401 (>K:ROTOR_BRAKE) }',
	'(L:switch_104_73X, number) s0 l0 0 == if{ 10401 (>K:ROTOR_BRAKE) } l0 100 == if{ 10402 (>K:ROTOR_BRAKE) }')
-- bit 37 EXT LT_STORBE_ON ← PMDG737 POSITION STEADY&STROBE/OFF
kayeroof:CfgRpn(37,
	'0 (L:switch_123_73X,number) - 50 div s0 :1 l0 0 > if{ 12301 (>K:ROTOR_BRAKE) l0 -- s0 g1 } l0 0 < if{ 12302 (>K:ROTOR_BRAKE) l0 ++ s0 g1 }',
	'50 (L:switch_123_73X,number) - 50 div s0 :1 l0 0 > if{ 12301 (>K:ROTOR_BRAKE) l0 -- s0 g1 } l0 0 < if{ 12302 (>K:ROTOR_BRAKE) l0 ++ s0 g1 }')
-- bit 38 EXT LT_STORBE_OFF ← PMDG737 POSITION STEADY/OFF
kayeroof:CfgRpn(38,
	'100 (L:switch_123_73X,number) - 50 div s0 :1 l0 0 > if{ 12301 (>K:ROTOR_BRAKE) l0 -- s0 g1 } l0 0 < if{ 12302 (>K:ROTOR_BRAKE) l0 ++ s0 g1 }',
	'50 (L:switch_123_73X,number) - 50 div s0 :1 l0 0 > if{ 12301 (>K:ROTOR_BRAKE) l0 -- s0 g1 } l0 0 < if{ 12302 (>K:ROTOR_BRAKE) l0 ++ s0 g1 }')
...
kayeroof:CfgRpn(43, '0 (L:switch_126_73X, number) == if{ 12601 (>K:ROTOR_BRAKE) }',
	'100 (L:switch_126_73X, number) == if{ 12601 (>K:ROTOR_BRAKE) }')
-- bit 44 EXT LT_NAV_OFF ← PMDG737 LOGO LIGHT ON/OFF
kayeroof:CfgRpn(44, '100 (L:switch_122_73X, number) == if{ 12201 (>K:ROTOR_BRAKE) }',
	'0 (L:switch_122_73X, number) == if{ 12201 (>K:ROTOR_BRAKE) }')
-- bit 45 EXT LT_RWY TURN_ON ← PMDG737 LANDING LIGHT BOTH ON/OFF
kayeroof:CfgRpn(45,
	'0 (L:switch_113_73X, number) == if{ 11301 (>K:ROTOR_BRAKE) } 0 (L:switch_114_73X, number) == if{ 11401 (>K:ROTOR_BRAKE) }',
	'100 (L:switch_113_73X, number) == if{ 11301 (>K:ROTOR_BRAKE) } 100 (L:switch_114_73X, number) == if{ 11401 (>K:ROTOR_BRAKE) }')
-- bit 47 EXT LT_LAND_L_ON ← PMDG737 L PACK OFF/AUTO
kayeroof:CfgRpn(47,
	'(L:switch_200_73X, number) s0 l0 50 == if{ 20002 (>K:ROTOR_BRAKE) } l0 100 == if{ 20002 (>K:ROTOR_BRAKE) 20002 (>K:ROTOR_BRAKE) }',
	'(L:switch_200_73X, number) s0 l0 0 == if{ 20001 (>K:ROTOR_BRAKE) } l0 100 == if{ 20002 (>K:ROTOR_BRAKE) }')
-- bit 48 EXT LT_LAND_L_PETPACT ← PMDG737 L PACK AUTO/HIGH
kayeroof:CfgRpn(48,
	'(L:switch_200_73X, number) s0 l0 50 == if{ 20001 (>K:ROTOR_BRAKE) } l0 0 == if{ 20001 (>K:ROTOR_BRAKE) 20001 (>K:ROTOR_BRAKE) }',
	'(L:switch_200_73X, number) s0 l0 0 == if{ 20001 (>K:ROTOR_BRAKE) } l0 100 == if{ 20002 (>K:ROTOR_BRAKE) }')
-- bit 49 EXT LT_LAND_R_ON ← PMDG737 R PACK OFF/AUTO
kayeroof:CfgRpn(49,
	'(L:switch_201_73X, number) s0 l0 50 == if{ 20102 (>K:ROTOR_BRAKE) } l0 100 == if{ 20102 (>K:ROTOR_BRAKE) 20102 (>K:ROTOR_BRAKE) }',
	'(L:switch_201_73X, number) s0 l0 0 == if{ 20101 (>K:ROTOR_BRAKE) } l0 100 == if{ 20102 (>K:ROTOR_BRAKE) }')
-- bit 50 EXT LT_LAND_R_PETPACT ← PMDG737 R PACK AUTO/HIGH
kayeroof:CfgRpn(50,
	'(L:switch_201_73X, number) s0 l0 50 == if{ 20101 (>K:ROTOR_BRAKE) } l0 0 == if{ 20101 (>K:ROTOR_BRAKE) 20101 (>K:ROTOR_BRAKE) }',
	'(L:switch_201_73X, number) s0 l0 0 == if{ 20101 (>K:ROTOR_BRAKE) } l0 100 == if{ 20102 (>K:ROTOR_BRAKE) }')
-- bit 51 EXT LT_NOSE_TO ← PMDG737 RUNWAY TURNOFF LIGHT BOTH ON/OFF
kayeroof:CfgRpn(51,
	'0 (L:switch_115_73X, number) == if{ 11501 (>K:ROTOR_BRAKE) } 0 (L:switch_116_73X, number) == if{ 11601 (>K:ROTOR_BRAKE) }',
	'100 (L:switch_115_73X, number) == if{ 11501 (>K:ROTOR_BRAKE) } 100 (L:switch_116_73X, number) == if{ 11601 (>K:ROTOR_BRAKE) }')
-- bit 52 EXT LT_NOSE_OFF ← PMDG737 TAXI LIGHT ON/OFF
kayeroof:CfgRpn(52, '100 (L:switch_117_73X, number) == if{ 11701 (>K:ROTOR_BRAKE) }',

...
function hcbravo_mode_cfg_ias()
    hcbravo:CfgCmd(13, 'sim/autopilot/airspeed_down', 'sim/none/none')
    hcbravo:CfgCmd(12, 'sim/autopilot/airspeed_up', 'sim/none/none')
end

function hcbravo_mode_cfg_crs()
    hcbravo:CfgCmd(13, 'sim/radios/obs_HSI_down', 'sim/none/none')
    hcbravo:CfgCmd(12, 'sim/radios/obs_HSI_up', 'sim/none/none')
end

function hcbravo_mode_cfg_hdg()
    hcbravo:CfgCmd(13, 'sim/autopilot/heading_down', 'sim/none/none')
    hcbravo:CfgCmd(12, 'sim/autopilot/heading_up', 'sim/none/none')
end

function hcbravo_mode_cfg_vs()
    hcbravo:CfgCmd(13, 'sim/autopilot/vertical_speed_down', 'sim/none/none')
    hcbravo:CfgCmd(12, 'sim/autopilot/vertical_speed_up', 'sim/none/none')
end

function hcbravo_mode_cfg_alt()
    hcbravo:CfgCmd(13, 'sim/autopilot/altitude_down', 'sim/none/none')
    hcbravo:CfgCmd(12, 'sim/autopilot/altitude_up', 'sim/none/none')
end

...
--================================ Output key binding
wwagp:CfgCmd(0, 'sim/instruments/chrono1_reset')
...
if not isINIA340 then
	...
	function key_4_long_func()
		uluaCmdOnce(cmd_auto_rto)
	end

	function key_4_short_func()
	...
	wwagp:CfgLongFc(4, 1000, key_4_long_func, key_4_short_func)
end
...
if not isINIA340 then
	...
	wwagp:GetMax("AirbusFBW/AutoBrkSel")
end

...
hcbravo:GetLeftred('1-sim/anim/gearL')
hcbravo:GetCentergreen('sim/flightmodel2/gear/deploy_ratio[0]')
hcbravo:GetCenterred('1-sim/anim/gearF')
hcbravo:GetRightgreen('sim/flightmodel2/gear/deploy_ratio[3]')
hcbravo:GetRightred('1-sim/anim/gearR')

...
function MiniFCU:SetSpdMode(val)
	if val == nil then val = self.d_spd_mode:Get() if not self.d_spd_mode:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s0_spd_mode, val) self:CommitSegment(0)
end
...
function MiniFCU:SetMachVal(val)
	if val == nil then val = self.d_mach_val:Get() if not self.d_mach_val:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s0_mach_val, val) self:CommitSegment(0)
end
...
function MiniFCU:SetSpdDashes(val)
	if val == nil then val = self.d_spd_dashes:Get() if not self.d_spd_dashes:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s0_spd_dashes, val) self:CommitSegment(0)
end
...
function MiniFCU:SetSpdVal(val)
	if val == nil then val = self.d_spd_val:Get() if not self.d_spd_val:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s0_spd_val, val) self:CommitSegment(0)
end
...
function MiniFCU:SetSpdDot(val)
	if val == nil then val = self.d_spd_dot:Get() if not self.d_spd_dot:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s0_spd_dot, val) self:CommitSegment(0)
end
...
function MiniFCU:SetHdgDashes(val)
	if val == nil then val = self.d_hdg_dashes:Get() if not self.d_hdg_dashes:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s0_hdg_dashes, val) self:CommitSegment(0)
end
...
function MiniFCU:SetHdgVal(val)
	if val == nil then val = self.d_hdg_val:Get() if not self.d_hdg_val:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s0_hdg_val, val) self:CommitSegment(0)
end
...
function MiniFCU:SetHdgDot(val)
	if val == nil then val = self.d_hdg_dot:Get() if not self.d_hdg_dot:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s0_hdg_dot, val) self:CommitSegment(0)
end
...
function MiniFCU:SetAltVal(val)
	if val == nil then val = self.d_alt_val:Get() if not self.d_alt_val:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s0_alt_val, val) self:CommitSegment(0)
end
...
function MiniFCU:SetAltDot(val)
	if val == nil then val = self.d_alt_dot:Get() if not self.d_alt_dot:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s0_alt_dot, val) self:CommitSegment(0)
end
...
function MiniFCU:SetVsDashes(val)
	if val == nil then val = self.d_vs_dashes:Get() if not self.d_vs_dashes:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s0_vs_dashes, val) self:CommitSegment(0)
end
...
function MiniFCU:SetVsVal(val)
	if val == nil then val = self.d_vs_val:Get() if not self.d_vs_val:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s0_vs_val, val) self:CommitSegment(0)
end
...
function MiniFCU:SetFpaVal(val)
	if val == nil then val = self.d_fpa_val:Get() if not self.d_fpa_val:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s0_fpa_val, val) self:CommitSegment(0)
end
...
function MiniFCU:SetHdgtrkMode(val)
	if val == nil then val = self.d_hdgtrk_mode:Get() if not self.d_hdgtrk_mode:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s0_hdgtrk_mode, val) self:CommitSegment(0)
end
...
function MiniFCU:SetBaroUnit(val)
	if val == nil then val = self.d_baro_unit:Get() if not self.d_baro_unit:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s1_baro_unit, val) self:CommitSegment(1)
end
...
function MiniFCU:SetBaroStd(val)
	if val == nil then val = self.d_baro_std:Get() if not self.d_baro_std:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s1_baro_std, val) self:CommitSegment(1)
end
...
function MiniFCU:SetQnh(val)
	if val == nil then val = self.d_qnh:Get() if not self.d_qnh:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s1_qnh, val) self:CommitSegment(1)
end
...
function MiniFCU:SetBaroHpa(val)
	if val == nil then val = self.d_baro_hpa:Get() if not self.d_baro_hpa:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s1_baro_hpa, val) self:CommitSegment(1)
end
...
function MiniFCU:SetBaroInhg(val)
	if val == nil then val = self.d_baro_inhg:Get() if not self.d_baro_inhg:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s1_baro_inhg, val) self:CommitSegment(1)
end
...
function MiniFCU:SetCstr(val)
	if val == nil then val = self.d_cstr:Get() if not self.d_cstr:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s1_cstr, val) self:CommitSegment(1)
end
...
function MiniFCU:SetWpt(val)
	if val == nil then val = self.d_wpt:Get() if not self.d_wpt:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s1_wpt, val) self:CommitSegment(1)
end
...
function MiniFCU:SetVord(val)
	if val == nil then val = self.d_vord:Get() if not self.d_vord:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s1_vord, val) self:CommitSegment(1)
end
...
function MiniFCU:SetNdb(val)
	if val == nil then val = self.d_ndb:Get() if not self.d_ndb:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s1_ndb, val) self:CommitSegment(1)
end
...
function MiniFCU:SetArpt(val)
	if val == nil then val = self.d_arpt:Get() if not self.d_arpt:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s1_arpt, val) self:CommitSegment(1)
end
...
function MiniFCU:SetFd(val)
	if val == nil then val = self.d_fd:Get() if not self.d_fd:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s1_fd, val) self:CommitSegment(1)
end
...
function MiniFCU:SetLs(val)
	if val == nil then val = self.d_ls:Get() if not self.d_ls:ChangedUpdate() then return end end
	uluaSet(_G.idr_minifcu_mf_s1_ls, val) self:CommitSegment(1)
end

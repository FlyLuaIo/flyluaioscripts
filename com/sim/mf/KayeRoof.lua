...
function KayeRoof:SetLeds()
	self:SetFireL()
	self:SetAntiIceEng2Up()
	self:SetAntiIceEng1Down()
	self:SetAntiIceEng2Down()
	self:SetAntiIceWingDown()
	self:SetApuBleedDown()
	self:SetExtPwrDown()
	self:SetElecPumpDown()
	self:SetFireC()
	self:SetBat1Down()
	self:SetBat2Up()
	self:SetBat2Down()
	...
	self:SetIr3Lower()
	self:SetExtPwrUp()
	self:SetAntiIceWingUp()
	self:SetApuBleedUp()
	self:SetElecPumpUp()
	self:SetAntiIceEng1Up()
	self:SetCrewSupply()
	self:SetGndCtl()
	self:SetBat1Up()
	self:SetLtkPumps1Up()
	self:SetLtkPumps2Down()
	self:SetIr3Up()
	self:SetIr2Up()
	self:SetRtkPumps1Up()
	self:SetLtkPumps1Down()
	self:SetLtkPumps2Up()
	self:SetPump1Up()
	self:SetModeSelDown()
	self:SetPump2Down()
	...
	self:SetPump2Up()
	self:SetModeSelUp()
	self:SetRtkPumps2Down()
	self:SetRtkPumps1Down()
	self:SetRtkPumps2Up()
	self:SetXFeedUp()
	self:SetXFeedDown()
	self:SetMasterSwUp()
	self:SetMasterSwDown()
	self:SetStartUp()
	self:SetBat1v2()
end

function KayeRoof:SetLedsOff()
	self:SetFireL(0)
	self:SetAntiIceEng2Up(0)
	self:SetAntiIceEng1Down(0)
	self:SetAntiIceEng2Down(0)
	self:SetAntiIceWingDown(0)
	self:SetApuBleedDown(0)
	self:SetExtPwrDown(0)
	self:SetElecPumpDown(0)
	self:SetFireC(0)
	self:SetBat1Down(0)
	self:SetBat2Up(0)
	self:SetBat2Down(0)
	...
	self:SetIr3Lower(0)
	self:SetExtPwrUp(0)
	self:SetAntiIceWingUp(0)
	self:SetApuBleedUp(0)
	self:SetElecPumpUp(0)
	self:SetAntiIceEng1Up(0)
	self:SetCrewSupply(0)
	self:SetGndCtl(0)
	self:SetBat1Up(0)
	self:SetLtkPumps1Up(0)
	self:SetLtkPumps2Down(0)
	self:SetIr3Up(0)
	self:SetIr2Up(0)
	self:SetRtkPumps1Up(0)
	self:SetLtkPumps1Down(0)
	self:SetLtkPumps2Up(0)
	self:SetPump1Up(0)
	self:SetModeSelDown(0)
	self:SetPump2Down(0)
	self:SetPump1Down(0)
	self:SetStartDown(0)
	self:SetPump2Up(0)
	self:SetModeSelUp(0)
	self:SetRtkPumps2Down(0)
	self:SetRtkPumps1Down(0)
	self:SetRtkPumps2Up(0)
	self:SetXFeedUp(0)
	self:SetXFeedDown(0)
	self:SetMasterSwUp(0)
	self:SetMasterSwDown(0)
	self:SetStartUp(0)
	self:SetBat1v2(0)
end

...
function Stkmulti:absent(FastTurnsPerSecond)
	if not uluaFind('cpuwolf/flyluaio/StkMulti/leds/up1') then
		return true
	end
	_G.idr_stkmulti_hid_leds_up1 = uluaFind('cpuwolf/flyluaio/StkMulti/leds/up1')
	_G.idr_stkmulti_hid_leds_up2 = uluaFind('cpuwolf/flyluaio/StkMulti/leds/up2')
	_G.idr_stkmulti_hid_leds_up3 = uluaFind('cpuwolf/flyluaio/StkMulti/leds/up3')
	_G.idr_stkmulti_hid_leds_up4 = uluaFind('cpuwolf/flyluaio/StkMulti/leds/up4')
	_G.idr_stkmulti_hid_leds_up5 = uluaFind('cpuwolf/flyluaio/StkMulti/leds/up5')
	_G.idr_stkmulti_hid_leds_down1 = uluaFind('cpuwolf/flyluaio/StkMulti/leds/down1')
	_G.idr_stkmulti_hid_leds_down2 = uluaFind('cpuwolf/flyluaio/StkMulti/leds/down2')
	_G.idr_stkmulti_hid_leds_down3 = uluaFind('cpuwolf/flyluaio/StkMulti/leds/down3')
	_G.idr_stkmulti_hid_leds_down4 = uluaFind('cpuwolf/flyluaio/StkMulti/leds/down4')
	_G.idr_stkmulti_hid_leds_down5 = uluaFind('cpuwolf/flyluaio/StkMulti/leds/down5')
	_G.idr_stkmulti_hid_leds_leds = uluaFind('cpuwolf/flyluaio/StkMulti/leds/leds')
	_G.idr_stkmulti_hid_leds_ap_ap = uluaFind('cpuwolf/flyluaio/StkMulti/leds/AP_ap')
	_G.idr_stkmulti_hid_leds_ap_hdg = uluaFind('cpuwolf/flyluaio/StkMulti/leds/AP_hdg')
	_G.idr_stkmulti_hid_leds_ap_nav = uluaFind('cpuwolf/flyluaio/StkMulti/leds/AP_nav')
	_G.idr_stkmulti_hid_leds_ap_ias = uluaFind('cpuwolf/flyluaio/StkMulti/leds/AP_ias')
	_G.idr_stkmulti_hid_leds_ap_alt = uluaFind('cpuwolf/flyluaio/StkMulti/leds/AP_alt')
	_G.idr_stkmulti_hid_leds_ap_vs = uluaFind('cpuwolf/flyluaio/StkMulti/leds/AP_vs')
	_G.idr_stkmulti_hid_leds_ap_apr = uluaFind('cpuwolf/flyluaio/StkMulti/leds/AP_apr')
	_G.idr_stkmulti_hid_leds_ap_rev = uluaFind('cpuwolf/flyluaio/StkMulti/leds/AP_rev')
	_G.idr_stkmulti_hid_invalid = uluaFind('cpuwolf/flyluaio/StkMulti/invalid')
	_G.idr_stkmulti_hid_fastkeypersec = uluaFind('cpuwolf/flyluaio/StkMulti/fastkeypersec')
	uluaSet(_G.idr_stkmulti_hid_fastkeypersec, FastTurnsPerSecond)

	self.dr_mode_alt = iDataRef:New('cpuwolf/flyluaio/StkMulti/keysmap[0]')
	self.dr_mode_vs = iDataRef:New('cpuwolf/flyluaio/StkMulti/keysmap[1]')
	self.dr_mode_ias = iDataRef:New('cpuwolf/flyluaio/StkMulti/keysmap[2]')
	self.dr_mode_hdg = iDataRef:New('cpuwolf/flyluaio/StkMulti/keysmap[3]')
	self.dr_mode_crs = iDataRef:New('cpuwolf/flyluaio/StkMulti/keysmap[4]')
	return false
end
